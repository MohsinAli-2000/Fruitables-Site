...
const FruitCard = ({
  imageSrc = "/rasberries.jpg",import { faLock } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import PropTypes from "prop-types";
...
const FruitCard = ({
  ...
  return (
    <div className="flex flex-col justify-center items-center border border-orange-400 rounded-xl my-6 mx-2 sm:mx-1 md:mx-2 lg:mx-3 max-w-full sm:max-w-sm md:max-w-sm lg:max-w-72 hover:scale-105 hover:shadow-xl bg-gray-100 transition-transform duration-600 relative">
      <img
